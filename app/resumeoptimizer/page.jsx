...
export default function ResumeOptimizerDashboard() {
  ...
  const handleOptimizeResume = () => {
    router.push("/resumeoptimizer/scan-resume");
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8 mt-6">
          ...
          <div>
            ...
            >
              <div>
                <h2 className="text-2xl font-bold">
                  Optimize & Upgrade <br /> Your Resume Score
                </h2>
              </div>
              <motion.button
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  Optimize Now <Plus size={16} />
                </motion.button>
              </div>

              <div className="space-y-4">
                {optimizationHistory.map((resume, index) => (
                  <motion.div
                    key={resume.id}
          ...
          >
            ...
            <p className="text-sm text-indigo-200 mb-6 text-center">
              Get suggestions, keywords & structure fixes
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              onClick={handleOptimizeResume}
