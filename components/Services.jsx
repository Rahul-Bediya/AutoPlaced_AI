...
//               className={`group text-center border-b-2 pb-4 transition-all cursor-pointer ${
//                 selected === card.id
//                   ? "border-indigo-600"
...
//                 <div
//                   className={`bg-gray-50 rounded-xl p-3 mb-3 flex items-center justify-center shadow-sm transition ${
//                     selected === card.id ? "shadow-md scale-105" : ""
//                   }`}
//                 >
//                   {card.icon}
//                 </div>
